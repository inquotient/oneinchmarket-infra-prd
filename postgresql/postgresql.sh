...
sudo kubectl apply -f postgresql-configmap.yaml -f postgresql-headless.yaml -f postgresql-statefulset.yaml -f postgresql-nodeport.yaml -f postgresql-loadbalancer.yaml -n dev
